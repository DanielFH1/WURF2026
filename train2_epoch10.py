# epoch만 10으로 변경 , lora rank와 alpha는 16 32
...
OUTPUT_DIR = "./checkpoints/mvsm_epoch10" 
...
def train():
    ...
    train_dataset = load_dataset("data_train/train.jsonl") # train dataset
    val_dataset = load_dataset("data_train/val.jsonl") # val dataset
    ...
    training_args = TrainingArguments(
        ...
        num_train_epochs=10,          # train_epoch를 10으로 늘림.
