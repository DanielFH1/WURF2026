...
# [체크] 베이스 모델명 정확히 기재 (2.5 버전)
MODEL_ID = "Qwen/Qwen2.5-VL-3B-Instruct"

# [변경] 저장 경로: 최종 실험이므로 이름 구분을 확실하게
OUTPUT_DIR = "./checkpoints/mvsm_visual_cot_final"

# [변경] 데이터셋 경로: 방금 만든 Visual CoT Real 데이터셋 지정
DATA_DIR = "data_train_scene_split"
TRAIN_FILE = os.path.join(DATA_DIR, "train_visual_cot_real.jsonl") 
VAL_FILE = os.path.join(DATA_DIR, "val.jsonl")

# 이미지 루트 경로 (서버 환경에 맞게 유지)
...
def train():
    wandb.init(name="Visual-CoT-Final-Epoch3") 
    ...
    print(f"✨ Visual CoT 학습 완료: {OUTPUT_DIR}")
